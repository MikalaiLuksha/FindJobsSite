...
<head>
    ...
    <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/user/employer/account/update">Update information</a>
            </li>
        </ul>
    </nav>
</head>
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-6">${currentEmployer.firstName}</dd>
                    <dt class="col-sm-4 offset-sm-1"> Last Name</dt>
                    <dd class="col-sm-6">${currentEmployer.lastName}</dd>
                    <dt class="col-sm-4 offset-sm-1"> Company </dt>
                    <dd class="col-sm-6">${currentEmployer.company}</dd>
                    <dt class="col-sm-4 offset-sm-1"> Telephone </dt>
                    <dd class="col-sm-6">${currentEmployer.phone}</dd>
                    <dt class="col-sm-4 offset-sm-1"> Email </dt>
                    <dd class="col-sm-6">${currentEmployer.email}</dd>
                    <dt class="col-sm-4 offset-sm-1"> Address </dt>
                    <dd class="col-sm-6">${currentEmployer.address}</dd>
                </dl>

        ...
        <div class="form-group text-light">
            ...
            <select class="form-control col-2 offset-sm-2" name="nationality">
                <#list nationality as nati>
                    <option value="${nati.name}"> ${nati.name}</option>
                </#list>
            </select>
                   </div>
</div>
<div class="form-group text-light">
    <label for="phone" class="offset-sm-2">Телефон</label>
    <input type="text" name="phone" id="phone" class="form-control bfh-phone col-2 offset-sm-2" data-format="+375 (dd) ddd-dddd" value="" pattern="(\+[\d\ \(\)\-]{16})">
</div>
